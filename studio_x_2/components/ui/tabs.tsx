...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // Radix Tabs sets data-state="active" on the trigger, NOT a bare
        // data-active — so active styling MUST key off data-[state=active].
        // (data-active: variants compiled to [data-active] and never matched,
        // leaving the selected tab visually undistinguished — 2026-07-15.)
        ...
        "data-[state=active]:bg-background data-[state=active]:font-semibold data-[state=active]:text-foreground data-[state=active]:ring-1 data-[state=active]:ring-stroke dark:data-[state=active]:bg-background dark:data-[state=active]:text-foreground group-data-[variant=line]/tabs-list:data-[state=active]:ring-0",
