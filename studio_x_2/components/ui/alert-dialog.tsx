    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          // Grid children default to min-width:auto, so long content pushed past
          // the panel edge; a tall one ran off the screen with its buttons.
...
function AlertDialogHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "grid min-w-0 grid-rows-[auto_1fr] place-items-center gap-1.5 text-center [&>*]:min-w-0 has-data-[slot=alert-dialog-media]:grid-rows-[auto_auto_1fr] has-data-[slot=alert-dialog-media]:gap-x-6 sm:group-data-[size=default]/alert-dialog-content:place-items-start sm:group-data-[size=default]/alert-dialog-content:text-left sm:group-data-[size=default]/alert-dialog-content:has-data-[slot=alert-dialog-media]:grid-rows-[auto_1fr]",
        className
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "font-heading text-lg font-medium text-balance leading-tight sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2",
        className
      )}
      {...props}
    />
