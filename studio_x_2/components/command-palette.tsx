...
const COMMANDS: Command[] = [
  ...
  { id: "ag-channel",    label: "Set up deployment · numbers, widget, SDK", href: "/agents?step=2", wizardStep: 2, icon: Phone, group: "Agent settings", keywords: ["deployment", "batch calls", "inbound", "outbound", "channel", "phone number", "web widget", "widget ui", "whatsapp", "telegram", "sdk"] },
  ...
  { id: "ag-tools",      label: "Knowledge, MCP & tools", href: "/agents?step=3", wizardStep: 3, icon: Bot,       group: "Agent settings", keywords: ["knowledge base", "mcp", "connector", "crm", "tools", "history", "memory"] },
  ...
  { id: "ag-deploy",     label: "Go Live · campaign runs, outputs, deploy", href: "/agents?step=5", wizardStep: 5,   icon: Activity,           group: "Agent settings", keywords: ["deploy", "go live", "publish", "review", "campaign", "run", "rerun", "contacts", "csv", "caller id", "call window", "concurrency", "structured outputs", "transcripts", "recording", "version history"] },
