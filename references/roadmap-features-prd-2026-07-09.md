...
|---|---|---|---|---|---|---|
| A1 | Improve Onboarding | Land | **P0** | ✗ / TS | Highest-frequency friction; every stage inherits it. Project creation >30s, weak templates, defaults trail Retell. | **Console-owned**, no external dep. Faster provisioning + better default templates + smart-model-by-default + latency parity. |
