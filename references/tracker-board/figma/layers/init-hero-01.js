const JOB = {"step":"init","width":1440,"height":1100,"bg":{"r":0.9921568627450981,"g":0.9882352941176471,"b":0.9882352941176471,"a":1},"sectionName":"7 · Hero screens","parentSectionId":"3122:40585","imageHash":"b3cb5bb54c0fb31aed29e8a5a180d592483af0dd","frameName":"Hero · 01 Select voice — Recommended · Compare · Add your own voice (editable)","placeAt":null,"rationale":["Happy scenario = pick once, go live: the Recommended strip ranks three voices from the prompt's use case (voice tags, not benchmarks — the InfoHint says so) above the untouched catalog.","Compare is a column, not a mode: shortlist ≤3, hear them on the same script in the tray, Use voice stays one click; 'Read my greeting' is disabled with 'Requires Studio preview' until the endpoint exists.","Add your own voice is an id, a name, an unchecked consent and a scope line — no fake verification.","How to edit: every label, chip and row text is a text layer; the page behind is the live build, for context only.","Open decisions: may we say 'Recommended' from tags before the benchmark? Sign off the consent line."]}
