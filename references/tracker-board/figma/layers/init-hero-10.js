const JOB = {"step":"init","width":1440,"height":1397,"bg":{"r":0.9921568627450981,"g":0.9882352941176471,"b":0.9882352941176471,"a":1},"sectionName":"7 · Hero screens","parentSectionId":"3122:40594","imageHash":"56f829db414e90633c62f18664572fae7c435209","frameName":"Hero · 10 Call sheet — one clock, badges, Copy link · Download (editable)","placeAt":null,"rationale":["Happy scenario = replay and name the cause: one clock — every transcript line carries its time and seeks the recording; the scrubber shows the turn map.","Greeting · Interrupted · Ignored · Error chips say how the turn ended, titles carry the Engine reason; untimed calls say 'No timestamps for this call' instead of faking a clock.","Copy link and one Download menu (recording, transcript .txt/.json) replace scattered ghost buttons; missing audio is a stated state (No recording · Not retained).","The same grammar runs on the session page — one shared detail, lists untouched (tension #2 stays the owner's call).","Open decisions: Call History vs Session History; what 'redacted' hides."]}
