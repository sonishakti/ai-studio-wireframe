const JOB = {"step":"init","width":1440,"height":1100,"bg":{"r":0.9921568627450981,"g":0.9882352941176471,"b":0.9882352941176471,"a":1},"sectionName":"7 · Hero screens","parentSectionId":"3122:40586","imageHash":"714eff8e0c38043d07a2513fe5835d34e089cf60","frameName":"Hero · 02 Agent Speech Settings — Turn-taking · Listening (editable)","placeAt":null,"rationale":["Happy scenario = caller interrupts, agent listens: one Turn-taking row with Responsive · Balanced · Patient · Custom and a recap that resolves the preset to visible milliseconds (868kykhaz).","Custom folds to the raw rows that already exist below — nothing duplicated; any manual edit flips the preset to Custom.","Listening renames SAL to what it does (Lock onto one speaker); Backchannels and Preemptive replies are visible, inert, captioned 'Requires Engine' with the intent kept in this browser.","Try interrupting on the Talk tab prints 'Interrupted after {ms} · {preset} · resumed with your words' — testing is ambient, one chip.","Open decisions: replace the raw preset cards or keep them under Custom? Which month to print on the inert rows."]}
