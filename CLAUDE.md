...
0a. **Review loop (2026-09-11):** Figma page → feature → JTBD → competitors (4 vendors, screenshots) → our proposal (red-marked shots) → prototype link; the **Design Delivery Board** https://claude.ai/code/artifact/a1d57eb9-2121-484c-b2f6-2d728cbd1466 is the canonical row per ClickUp task (`references/tracker-board/`). Section "Review loop" in `references/design-ops-protocol.md`.
